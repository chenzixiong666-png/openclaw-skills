...
queries = {
    'projects': '{ projects(limit: 50) { uuid name key } }',
    'cards': '{ cards(limit: 20) { uuid name type objectId objectType key } }',
    'taskSampleMore': '{ tasks(limit: 50) { uuid name number issueType { uuid name } issueTypeScope { uuid } status { name category } } }',
}
